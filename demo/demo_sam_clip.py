...
import sys
sys.path.append('.')
from clip_fast_rcnn.clip_rcnn import build_clip_rcnn
...
def show_anns_with_scores(img_size, anns, scores, text_prompt):
    ...
    num_show_obj = len([ann for ann in sorted_anns if ann['clip_score'] >= 0.5])
...
if __name__ == "__main__":
    ...
    plt.savefig(
        os.path.join(output_dir, "sam_clip_output_{}".format(image_name)),
